...
CREATE TABLE IF NOT EXISTS `dwtf_db`.`dm_candidato` (
  ...
  `seq_opcao1` INT NULL COMMENT '',
  `seq_opcao2` INT NULL COMMENT '',
  `sexo` CHAR(1) NULL COMMENT '',
  `trabalha` CHAR(1) NULL COMMENT '',
  `pre_vest` CHAR(1) NULL COMMENT '',
  `idade` CHAR(2) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `dwtf_db`.`dm_socioeconomico` (
  ...
  `renda_per_capita` VARCHAR(45) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `dwtf_db`.`ft_desempenho` (
  ...
  PRIMARY KEY (`seq_pk`, `seq_evento`, `seq_curso`, `seq_candidato`, `seq_socioeconomico`, `seq_regiao`)  COMMENT '',
